var comments = {
  "comments": [
    ...
    },
    {
      ...
      "comment": "Each of these styles can be applied by adding .list-wrapper--* to a wrapping element such as .list-wrapper--simple. This is helpful when a class cannot be directly added to a list."
    },
    {
      "el": "#nav",
      "title": "Navigation",
    ...
    {
      "el": ".featured-headline",
      "title": "Hero",
      "comment": "<p>The hero area highlights one major story using a large image and a captivating headline.</p>"
    },
    {
      "el": ".marketing-highlight",
      "title": "Marketing Highlight",
      "comment": "<p>Add the .marketing-highlight--featured class when using a highlight label (circle element).</p>"
    },
    {
      "el": ".gallery",
      "title": "Image Gallery",
      "comment": "<p>Add the .gallery--poster class to the wrapping div when only wanting to show 1 thumbnail to launch photoswipe.</p>"
    },
    {
      "el": ".collapse",
      "title": "Collapse",
      "comment": "<p>.u-hidden--visually is applied to the content by default for accessibility reasons but is removed on page load by javascript and replaced with a display:none.</p>"
    }
  ]
};
